  ...
  return (
    ...
    n.reduce((l, r) => {
      ...
      if (
        ...
        (e.level = o),
        o > 1 && v && (e.parentId = v.id),
        e.children)
      ) {
        e.isLeaf = !1
        const t = S(e.children, o, e)
        return delete e.children, l.concat(e, t)
      } else return e.isLeaf === void 0 && (e.isLeaf = !0), l.concat(e)
    }, [])
  )
}
function U(n) {
...
function J(n, { getChildNodes: o }) {
  const v = l => {
    ...
    const r = n.value.find(s => s.id === l.parentId)
    if (!r) return
    o(r, !1).every(s => s.checked)
      ? ((r.checked = !0), i(r, !0))
      : ((r.checked = !1), i(r, !1))
  }
  function i(l, r) {
    if (l.parentId) {
      const e = n.value.find(t => t.id === l.parentId)
      r && o(e, !1).every(f => f.checked)
        ? ((e.checked = !0), i(e, !0))
        : ((e.checked = !1), i(e, !1))
    }
  }
...
function Q(n, { getChildNodes: o, getParentNode: v }, i) {
  const l = G({
    ...
    r = () => {
      ;(l.dropType = void 0),
        (l.draggingHtmlNode = null),
        (l.draggingTreeNode = null)
    },
    e = w(() =>
      n.value.reduce(
        (d, u) => ({
    ...
    f = (d, u) => {
      var p
      d.stopPropagation(),
        (l.draggingHtmlNode = d.target),
        (l.draggingTreeNode = u),
        (p = d.dataTransfer) == null || p.setData('dragNodeId', u.id)
    },
    a = d => {
      if (
        (d.preventDefault(), d.stopPropagation(), !!l.draggingHtmlNode && i)
      ) {
        if ((d.dataTransfer && (d.dataTransfer.dropEffect = 'move'), !n)) return
        let u = {}
        typeof i == 'object' ? (u = i) : i === !0 && (u = { inner: !0 })
        const { prev: p, next: c, inner: I } = u
        let g
        const L = p ? (I ? 0.25 : c ? 0.45 : 1) : -1,
          b = c ? (I ? 0.75 : p ? 0.55 : 0) : 1,
          m = d.currentTarget,
          k = m == null ? void 0 : m.getBoundingClientRect(),
          H = d.clientY - ((k == null ? void 0 : k.top) || 0)
        if (
          (H < ((k == null ? void 0 : k.height) || 0) * L
            ? (g = 'prev')
            : H > ((k == null ? void 0 : k.height) || 0) * b
            ? (g = 'next')
            : I
            ? (g = 'inner')
            : (g = void 0),
  ...
  function y(d, u) {
    ...
    if (p) {
      ...
      ;(l.dropType = 'inner'),
        I.forEach(L => y(L.id, c)),
        g && o(g).length === 0 && (g.isLeaf = !0)
    }
  }
  return {
    onDragStart: f,
...
function X(
  n,
  { getNode: o, getTreeNodeIndex: v, getChildNodes: i },
  { emit: l }
) {
  const r = (f, a) => {
      a.value.forEach(x => {
    ...
    t = f => {
      ...
      if (a) {
        a.loading = !1
        const x = C(S(f.childNodes, a.level))
        r(a, x), e(a, x)
        const N = i(a, !1)
  ...
  return {
    lazyLoadNode: f => {
      const a = o(f)
      ;(a == null ? void 0 : a.isLeaf) === !1 &&
        !a.childNodeCount &&
        ((a.loading = !0), l('lazy-load', f, t))
    }
  }
}
function Z(n, { getChildNodes: o, getTreeNodeIndex: v }) {
  return {
    ...
    removeTreeNode: r => {
      ...
      e.length === 0
        ? (n.value = n.value.filter(t => t.id !== r.id))
        : (n.value = n.value.filter(t => t.id !== r.id && !e.includes(t.id)))
    }
  }
}
function ee(n) {
  const o = (e, t = !0) => {
    const s = [],
      f = n.value.findIndex(a => a.id === e.id)
  ...
  return {
    ...
    getNode: e => {
      if (e) return n.value.find(t => t.id === e.id)
    },
    getParentNode: e => {
      if (e) return n.value.find(t => t.id === e.parentId)
    }
  }
}
function ne(n, o, v) {
  ...
  le = D({
    ...
    setup(n, { slots: o }) {
      ...
      return (
        ...
        () => {
          var k, H, E
          let { level: g, expanded: L, isLeaf: b, checked: m } = V(l)
          return h(
            'div',
            {
            ...
            [
              ...
              h(
                ...
                [
                  ...
                  (H = o.content) == null ? void 0 : H.call(o),
                  r.value &&
                    p.value &&
                    h(
                      'span',
                  ...
                  e.value &&
                    l.value.loading &&
                    ((E = o.loading) == null ? void 0 : E.call(o))
                ]
              )
            ]
          )
...
const ie = D({
    ...
    props: re,
    setup(n, { slots: o }) {
      const { data: v, itemHeight: i, component: l } = P(n),
        r = C(0),
        e = C(0),
        t = C(),
        s = C(0),
        f = w(() => Math.ceil(r.value / i.value)),
        a = w(() => {
  ...
  B = D({
    ...
    emits: ['lazy-load'],
    setup(n, o) {
      const { data: v, height: i, itemHeight: l } = P(n),
        { slots: r } = o,
        {
          clickExpandedNode: e,
...
export { B as Tree, de as default }
